    ...
    <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
       <a class="navbar-brand brand-logo" href="/"><img src="/assets/img/juniper.jpg" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="/"><img src="/assets/img/junipersmall.jpg" alt="logo"/></a>
      </div>
        ...
        <ul class="nav">
          ...
          <li class="nav-item">
			...
			<div id="menu">
				...
				<li class="nav-item"> 
					<a class="nav-link" data-toggle="collapse" href="#casem" aria-expanded="false" aria-controls="casem"> <span class="menu-title">Case Management</span> <i class="menu-arrow"></i> <i class="mdi mdi-account-settings-variant menu-icon"></i> </a> 
						<div class="collapse" id="casem"> 
							<ul class="nav flex-column sub-menu"> 
								<li class="nav-item"> <a class="nav-link" href="/casem/AlertHome"> View Alert </a></li> 
								<li class="nav-item"> <a class="nav-link" href="/casem/AlertHome"> Create Alert </a></li>
								<li class="nav-item"> <a class="nav-link" href="/casem/AlertHome"> Update Alert </a></li>
								<li class="nav-item"> <a class="nav-link" href="/casem/AlertHome"> Delete Alert </a></li>
							</ul>
						</div>
					</li>
				</div>

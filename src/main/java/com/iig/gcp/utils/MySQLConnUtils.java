...
public class MySQLConnUtils {
	...
	public static Connection getMySQLConnectionCase()
	         throws ClassNotFoundException, SQLException {
		 
	    Class.forName(MySqlConstants.MYSQL_DRIVER);
	     Connection conn = DriverManager.getConnection(MySqlConstants.MYSQL_JDBC_URL_CASE, MySqlConstants.MYSQL_USER,
	    		 MySqlConstants.MYSQL_PASSWORD);
	     return conn;
	 }
}
